...
// **** We have called all the functions here in the seed file. You just need to comment each function to check ****//
   ...
   /** seeding check customer function in dog owners database */
    ...
    // const createSitter = await data.createSitter("Gregg", "Vesendor", "12/12/1965", "gvese@yahoo.com", "099-234-2464", "male", "56th Street, NY", "New York City", "NY", "11102", "12345678", "65", "I am gregg, all dog owners trust me with their dogs.")
    // console.log(createSitter);
    ...
    // const createBooking = await bookings.createBooking('61b40a95478686d12776a387', '61b4272e83a50ed448ea0ca4', '2021-12-13 11:00', '2021-12-13 11:30', 50.00, 'Dog Walking');
    // console.log(createBooking);


    /** seeding bookings function in database */
    // const sitReviews = await bookings.sitterReviews('miller877@hotmail.com', '61b4272e83a50ed448ea0ca4', 4, 'I loved Xu Zhao service. She lived upto our expectations in terms of taking of our Bailey');
    // console.log(sitReviews);
    ...
    /** seeding bookings function in database */
    // const value = await bookings.GetbookingSitter('61b42612a04e998ecfd55e0d');
    // console.log(value);


     /** seeding bookings function in database */
    //  const updateStatus = await bookings.UpdateStatusBooking('61b5a0fbd4f545344543ae7b', 'Rejected');
    //  console.log(updateStatus);


     /** seeding bookings function in database */
    // const delBook = await bookings.delete('61b688b465a1f394d7a9e912');
    // console.log(delBook);
